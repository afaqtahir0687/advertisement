                                        ...
                                        <div class="product-default left-details product-widget">
                                            <figure>
                                                <a href="{{ route('products.index') }}">
                                                    ...
                                                    <img src="{{ asset('assets/images/products/small/product-4-2.jpg') }}" width="75"
                                                        height="75" alt="product" />
                                                </a>
                                            </figure>
                                            <div class="product-details">
                                            ...
                                            <figure>
                                                <a href="{{ route('products.index') }}">
                                                    <img src="{{ asset('assets/images/products/small/product-5.jpg') }}" width="75"
                                                        height="75" alt="product" />
                                                    <img src="{{ asset('assets/images/products/small/product-5-2.jpg') }}" width="75"
                                                        height="75" alt="product" />
                                                </a>
                                            </figure>
                                            <div class="product-details">
                                            ...
                                            <figure>
                                                <a href="{{ route('products.index') }}">
                                                    <img src="{{ asset('assets/images/products/small/product-6.jpg') }}" width="75"
                                                        height="75" alt="product" />
                                                    <img src="{{ asset('assets/images/products/small/product-6-2.jpg') }}" width="75"
                                                        height="75" alt="product" />
                                                </a>
                                            </figure>
                                            <div class="product-details">
                                            ...
                                            <figure>
                                                <a href="{{ route('products.index') }}">
                                                    <img src="{{ asset('assets/images/products/small/product-1.jpg') }}" width="75"
                                                        height="75" alt="product" />
                                                    <img src="{{ asset('assets/images/products/small/product-1-2.jpg') }}" width="75"
                                                        height="75" alt="product" />
                                                </a>
                                            </figure>
                                            <div class="product-details">
                                            ...
                                            <figure>
                                                <a href="{{ route('products.index') }}">
                                                    <img src="{{ asset('assets/images/products/small/product-2.jpg') }}" width="75"
                                                        height="75" alt="product" />
                                                    <img src="{{ asset('assets/images/products/small/product-2-2.jpg') }}" width="75"
                                                        height="75" alt="product" />
                                                </a>
                                            </figure>
                                            <div class="product-details">
                                            ...
                                            <figure>
                                                <a href="{{ route('products.index') }}">
                                                    <img src="{{ asset('assets/images/products/small/product-3.jpg') }}" width="75"
                                                        height="75" alt="product" />
                                                    <img src="{{ asset('assets/images/products/small/product-3-2.jpg') }}" width="75"
                                                        height="75" alt="product" />
                                                </a>
                                            </figure>
                                            <div class="product-details">
