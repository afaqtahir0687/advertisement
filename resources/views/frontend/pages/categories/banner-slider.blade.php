                ...
                <div class="col-lg-9">
                    <div class="boxed-slider owl-carousel owl-carousel-lazy owl-theme owl-theme-light">
                        <div class="boxed-slide boxed-slide-1">
                            <figure>
                                <img class="slide-bg owl-lazy" data-src="{{ asset('assets/images/banners/banner-fashion-1.jpg') }}"
                                    src="{{ asset('assets/images/banners/banner-fashion-1.jpg') }}" alt="banner" width="870"
                                    height="300">
                            </figure>
                        ...
                        <div class="boxed-slide boxed-slide-2">
                            <figure>
                                <img class="slide-bg owl-lazy" data-src="{{ asset('assets/images/banners/banner-fashion-2.jpg') }}"
                                    src="{{ asset('assets/images/banners/banner-fashion-2.jpg') }}" alt="banner" width="870"
                                    height="300">
                            </figure>
                            <div class="slide-content">
