...
@section('title', 'Blog Post Detail - Crelogics Insights')
@section('meta_description', 'Read our latest blog post on professional printing and branding strategies. Expert advice for your business growth.')
@section('meta_keywords', 'blog post, printing tips, advertisement strategy, branding article, Crelogics blog detail')
@section('content')
    <main class="main">
                        ...
                        <div class="owl-carousel owl-theme related-posts-carousel" data-owl-options="{
                            ...
                            <article class="post">
                                ...
                                <div class="post-body">
                                    ...
                                    <h2 class="post-title">
                                        <a href="{{ route('single.index') }}">Post Format - Image</a>
                                    </h2>
                        ...
                        <div class="widget">
                            ...
                            <ul class="simple-post-list">
                                <li>
                                    ...
                                    <div class="post-info">
                                        <a href="{{ route('single.index') }}">Post Format - Video</a>
                                        <div class="post-meta">
                                            April 08, 2018
                                        </div><!-- End .post-meta -->
                                    </div><!-- End .post-info -->
