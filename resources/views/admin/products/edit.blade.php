                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="sku" class="form-control" value="{{ $product->sku }}" placeholder="SKU code">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <textarea name="short_description" id="short_description" class="form-control" rows="2" placeholder="Brief overview">{{ $product->short_description }}</textarea>
                        </div>
                        <div class="form-group">
                            <label class="font-weight-bold">Full Description</label>
                            <textarea name="description" id="description" class="form-control" rows="5" placeholder="Detailed specs">{{ $product->description }}</textarea>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="font-weight-bold">Size Guide</label>
                                    <textarea name="size_guide" id="size_guide" class="form-control" rows="3" placeholder="HTML for size guide">{{ $product->size_guide }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="font-weight-bold">Additional Info</label>
                                    <textarea name="additional_info" id="additional_info" class="form-control" rows="3" placeholder="Technical/Shipping">{{ $product->additional_info }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="materials" class="form-control" value="{{ $product->materials ? implode(', ', $product->materials) : '' }}" placeholder="e.g. Matt, Gloss">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="side_1_colors" class="form-control" value="{{ $product->side_1_colors ? implode(', ', $product->side_1_colors) : '' }}" placeholder="e.g. CMYK">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="lamination_types" class="form-control" value="{{ $product->lamination_types ? implode(', ', $product->lamination_types) : '' }}" placeholder="e.g. Matte Lamination">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="font-weight-bold">Die Cutting</label>
                                    <input type="text" name="die_cutting_options" class="form-control" value="{{ $product->die_cutting_options ? implode(', ', $product->die_cutting_options) : '' }}" placeholder="e.g. Custom, Ready">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="file" name="image" class="form-control-file border p-1 rounded w-100">
                            @if($product->image)
                                <img src="{{ asset('storage/' . $product->image) }}" width="80" class="mt-2 rounded shadow-sm">
                            @endif
                        </div>
                        <div class="form-group">
                            ...
                            @if($product->images)
                                <div class="mt-2 d-flex flex-wrap gap-2">
                                    @foreach($product->images as $img)
                                         <img src="{{ asset('storage/' . $img) }}" width="40" height="40" class="rounded border m-1">
                                    @endforeach
                                </div>
                            @endif
                        </div>
                        ...
                        <button type="submit" class="btn btn-primary btn-block btn-lg mt-4"><i class="fas fa-sync mr-1"></i> Update Product</button>
                    </div>
                </div>
            </div>
        </div>
